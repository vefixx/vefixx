...
Привет! Меня зовут Артем, мне 16 лет, я разработчик, специализирующийся на языке программирования Python. Мое увлечение - создание ботов для **Discord**, **VK** и **Telegram**, создание скриптов-Парсеров.

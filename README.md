...
Занимаюсь разработкой на .NET в коммерческом секторе последние 2 года. Основной фокус - автоматизация задач и интеграции. Реализовывал решения для работы с маркетплейсами, создавал серверную часть для ботов и утилиты обработки данных. В ежедневной работе использую парсинг, взаимодействие с внешними API и разработку фоновых процессов.
